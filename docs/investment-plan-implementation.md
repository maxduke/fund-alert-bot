...
required drawdown and trend range; later after-close evaluations fetch only a
small overlapping range and upsert it. Before-close evaluation reads the last
confirmed rows and still fetches one realtime quote per ETF. The plan-status
