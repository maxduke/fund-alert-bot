...
_EN_TO_ZH = {
    ...
    "Show local task and delivery status": "显示本地任务与投递状态",
    "Reading plan status. Please wait for the result.": "正在读取计划状态，请等待查询结果。",
    "Running checks. Please wait for the result.": "正在执行检查，请等待检查结果。",
    "Query failed. Please try again or check /status.": "查询失败，请稍后重试，或使用 /status 查看运行状态。",
    "Unable to read local status. Please try again.": "无法读取本地运行状态，请稍后重试。",
    "Runtime status": "运行状态",
    "Rule": "规则",
    "Event": "提醒事件",
    "Oldest pending DCA estimates:": "最早待处理的定投估算：",
    "Oldest pending additions:": "最早待处理的手动加仓估算：",
    "Oldest unfinished deliveries:": "最早未完成的投递：",
    "Original date:": "原始日期：",
    "Effective date:": "生效日期：",
    ...
    "Effective date has not completed.": "生效日期尚未结束。",
    "Initial position is missing; position sync required.": "缺少初始持仓，需要同步持仓。",
    "Position reconciliation is required.": "持仓已标记为需要对账。",
    "Exact-date NAV unavailable locally; remote publication unknown.": "本地没有可用的准确日期净值；未检查远端是否已发布。",
    "Review with:": "核对命令：",
    "If not executed:": "如果实际未执行：",
    "Additional pending items omitted.": "其余待处理记录已省略。",
    "Additional cached symbols omitted.": "其余缓存标的已省略。",
    "Awaiting delivery": "等待投递",
    "Delivery in flight": "投递中",
    "Delivery failed": "投递失败",
    "Delivery targets not yet assigned": "尚未分配投递目标",
    "Local prerequisites only; not a recorded failure diagnosis.": "以上仅依据本地处理条件，不代表已记录的失败原因。",
    "Command hints are incomplete; use /help for arguments.": "命令提示未包含全部参数；使用 /help 查看完整格式。",
    "Timezone:": "时区：",
    "Before-close check": "收盘前检查",
    "After-close check": "收盘后检查",
    "DCA check": "定投检查",
    "Fund NAV processing": "基金净值处理",
    "In progress": "运行中",
    "Completed successfully": "完整成功",
    "Incomplete (data or delivery problems)": "未完整完成（数据或投递问题）",
    "Execution failed": "执行失败",
    "No evaluation due": "本次无需评估",
    "Interrupted; no completion recorded": "已中断，未记录完成",
    "No record yet": "尚无记录",
    "Last started:": "最近开始：",
    "Last finished:": "最近结束：",
    "Last complete success:": "最近完整成功：",
    "Delivery problems:": "投递问题：",
    ...
    "Pending estimates may require NAV data, settings or position sync.": "待处理估算可能需要净值数据、补齐设置或同步持仓。",
    "Local market-data dates:": "本地行情数据日期：",
    "Fund NAV": "基金净值",
    "No cached market data": "尚无本地行情缓存",
    "Local records only; no market requests were made.": "仅查看本地记录，本次没有请求行情。",
    "Cached dates do not prove all rules were evaluated successfully.": "缓存日期不代表所有规则均已成功检查。",
    "DCA occurrence predates its rule; verify it with /dca_skip or /sync_position.": "定投记录早于规则创建日期；请使用 /dca_skip 或 /sync_position 核对处理。",
    ...
    "Add a Drawdown Add Plan": "添加回撤加仓计划",
    ...
    "Recent peak:": "近期高点：",
    "Peak date:": "高点日期：",
    "Drawdown Add Plan pre-alert": "回撤加仓计划预警",
    "Drawdown Add Plan reminder": "回撤加仓计划提醒",
    "Drawdown Add Plan pre-alert —": "回撤加仓计划预警 —",
    "Drawdown Add Plan reminder —": "回撤加仓计划提醒 —",
    "Buy-plan pre-alert": "回撤加仓计划预警",
    "Buy-plan reminder": "回撤加仓计划提醒",
    "Buy-plan pre-alert —": "回撤加仓计划预警 —",
    "Buy-plan reminder —": "回撤加仓计划提醒 —",
...
_DYNAMIC_PREFIXES = (
    ...
    "Set gain thresholds —",
    "Deduction failed —",
    "Drawdown Add Plan pre-alert —",
    "Drawdown Add Plan reminder —",
    "Buy-plan pre-alert —",
    "Buy-plan reminder —",
    "Checked ",
    "已检查 ",
